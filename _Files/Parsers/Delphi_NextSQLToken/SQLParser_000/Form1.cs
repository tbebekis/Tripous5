...
namespace SQLParser_000
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
      ...
      {
         //public static SQLToken NextToken(string SQL, int P, ref string Token, SQLToken CurSection)
         
         ListBox.Items.Clear();
         string SQL = Memo.Text;
         string Token = "";
         int P = 0;
         SQLToken CurSection = SQLToken.Unknown;
         string S;
