...
namespace Tripous.Model
{
    ...
    public class JsonDataTable
    {
        ...
        /// Constructor
        /// </summary>
        public JsonDataTable(DataTable Source, TableDescriptor Descriptor)
        {
            ...
            // columns
            FieldDescriptorBase FieldDescriptor;
            ...
            foreach (DataColumn SourceColumn in Source.Columns)
            {
                ...
                if (Descriptor != null)
                {
                    FieldDescriptor = Descriptor.FindAnyField(SourceColumn.ColumnName);
                }
        ...
        /// </summary>
        static public JObject ToJObject(DataTable Source, TableDescriptor Descriptor)
        {
