...
namespace Tripous.Model2
{
    ...
    public class SqlBrowser
    {
        ...
        protected virtual bool OnSelectBefore(SelectSql SelectSql)
        {
            ...
            {
                Tripous.Model.SelectSqlEventArgs ea = new Tripous.Model.SelectSqlEventArgs(SelectSql);
        ...
        /// </summary>
        public event EventHandler<Tripous.Model.SelectSqlEventArgs> SelectBefore;
