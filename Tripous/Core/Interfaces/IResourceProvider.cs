...
namespace Tripous
{
    ...
    /// <para>Each Assembly may contain a ResourceProvider class implementing this interface.
    /// It can contain more than one though.</para>
    /// <para>The ObjectStore loads automatically those classes implementing this interface. </para>
    /// </summary>
